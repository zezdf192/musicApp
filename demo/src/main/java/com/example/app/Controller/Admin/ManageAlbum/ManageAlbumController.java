...
public class ManageAlbumController implements Initializable {
    ...
    public void callAPI() {
        try{
            ...
            while (resultSet.next()) {
                ...
                String thumbnail = resultSet.getString("thumbnailAlbum");
    ...
    public void renderListUser() {
        ...
        for (int i = 0; i < listAlbum.size(); i++) {
            ...
            fxmlLoader.setLocation(getClass().getResource("/Fxml/Admin/ManageAlbum/ItemAlbum.fxml"));

            try {
                AnchorPane hBox = fxmlLoader.load();
                AlbumItemController cic = fxmlLoader.getController();
    ...
    private void findData() {
        ...
        try {
            ...
            String query = "";
            if(typeFind.equals("nameAlbum")) {
                 query = "SELECT * FROM album where " + typeFind + " LIKE ? " + typeRange;
            }else {
                query = "SELECT * FROM album where " + typeFind + " ? " + typeRange;
            }
    ...
    private void handleCreateNewAlbum() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Fxml/Admin/ManageAlbum/CreateAlbum.fxml"));
