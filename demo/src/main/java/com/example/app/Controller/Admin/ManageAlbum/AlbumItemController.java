...
public class AlbumItemController implements Initializable {
    private int id;
    ...
    public void updateAlbum() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Fxml/Admin/ManageAlbum/UpdateAlbum.fxml"));
